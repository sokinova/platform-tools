...
# This script creates the IAM role and associates it with the FluentD ServiceAccount

set -e

# Configuration
ENVIRONMENT=${1:-dev}
CLUSTER_NAME="temp-eks-cluster-${ENVIRONMENT}"
...
if aws iam get-role --role-name ${ROLE_NAME} 2>/dev/null; then
  ...
  aws iam create-role \
    ...
    --description "IAM role for FluentD S3 access in ${ENVIRONMENT}"
fi
...
echo ""
echo "Add this annotation to your FluentD ServiceAccount:"
